        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-linear-to-br from-purple-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/20">
                <Terminal className="w-5 h-5 md:w-6 md:h-6 text-white" />
              </div>
              <div>
                <h1 className="text-xl md:text-3xl font-black bg-linear-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent tracking-tight">CodeSpace</h1>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
        <div className="bg-[#161b22]/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-800/50 p-6 md:p-8">
          ...
          <div className="space-y-5">
            {/* ID Input */}
            <div>
              <label className=" text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider flex items-center gap-2">
